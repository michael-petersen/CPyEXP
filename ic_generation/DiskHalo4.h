...
class DiskHalo
{
  ...
  */
  ...
  double  double_disk_density(ExponentialDisk* disk1,
				     ExponentialDisk* disk2,
			      double R, double z);
    
  // double disk_surface_density(ExponentialDisk* disk, double R)
  double double_disk_surface_density(ExponentialDisk* disk1, ExponentialDisk* disk2, double R);
 ...
 public:
  ...
  AddDisk *newmod;
  SphericalModelTable *halo1, *halo2, *halo3, *halo4, *halo5;
  SphericalModelMulti *multi;
  ...
  void table_double_disk(vector<Particle>& part1, vector<Particle>& part2);
  ...
  void set_vel_double_disk(vector<Particle>& part1,vector<Particle>& part2);
  ...
  void write_double_disk_file(ostream &fou_halo, ostream &fou_disk1, ostream &fou_disk2,
